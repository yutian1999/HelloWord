...
public class Promotion implements Serializable {
	...
	public String getTitleImg() {
		...
		return Constant.BOS_MANAGER_URL+titleImg;
	}
	...
	//http://localhost:8083/upload/2d348ffc-7ac2-4b44-a055-6dd6e4911e9b.png
	public String getDescription() {
		if(description.contains(Constant.BOS_MANAGER_URL)){
			return description;
		}
		return description.replace("src=\"/upload", "src=\""+Constant.BOS_MANAGER_URL+"/upload");
	}
