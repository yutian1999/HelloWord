...
public class SmsUtils {
	private static String userid = "雨天_2012";
	private static String pass = "wyz947619447";
	...
	public static void main(String[] args) throws IOException {
		String randomCode = RandomStringUtils.randomNumeric(4);
		 System.out.println(sendSmsByHTTP("13961856604", randomCode));
		 System.out.println(sendSmsByHTTP("13961856604", "尊敬的用户您好，本次获取的验证码为："
